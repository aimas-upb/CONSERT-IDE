...
public class MultiPageEditorContributor extends BasicTextEditorActionContributor {
	...
	private void createActions() {
		sampleAction = new Action() {
			public void run() {
				MessageDialog.openInformation(null, "Exemplu_editor", "Sample Action Executed");
			}
		};
