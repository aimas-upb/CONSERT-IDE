...
public class ContextAnnotationWizard extends Wizard implements INewWizard {
	...
	public boolean performFinish() {
		ContextAnnotationModel model = createModelFromWizard();
	...
	private ContextAnnotationModel createModelFromWizard() {
		ContextAnnotationModel model = new ContextAnnotationModel();

		model.setID(Utils.generateID(projectName, ModelType.ANNOTATION, _pageOne.getTextName()));
