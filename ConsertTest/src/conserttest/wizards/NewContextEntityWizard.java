...
import conserttest.pages.MyPageOne;
import conserttest.pages.MyPageTwo;

public class NewContextEntityWizard extends Wizard implements INewWizard {
	protected WizardPage firstPage;
	protected WizardPage secondPage;

	public NewContextEntityWizard() {
		super();
	}
