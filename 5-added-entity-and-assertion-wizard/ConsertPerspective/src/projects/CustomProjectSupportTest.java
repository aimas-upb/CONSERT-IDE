...
public class CustomProjectSupportTest {
    ...
    @Test
    public void testCreateProjectWithEmptyNameArg() throws IOException {
        String projectName = " "; //$NON-NLS-1$
        assertCreateProjectWithBadNameArg(projectName);
    }
 
    @Test
    public void testCreateProjectWithNullNameArg() throws IOException {
    ...
    private void assertCreateProjectWithBadNameArg(String name) throws IOException {
        URI location = null;
        try {
